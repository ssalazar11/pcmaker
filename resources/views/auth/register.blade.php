            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="phoneNumber" class="col-md-4 col-form-label text-md-end">{{ __('Telephone') }}</label>
                                                ...
                                                <div class="card mb-5">
                                                    <div class="card-body d-flex flex-column align-items-center">
                                                        ...
                                                        <form class="text-center" method="post">
                                                            ...
                                                            <div class="mb-3"><input class="form-control" type="password" name="Email Address" placeholder="Email Address"></div>
                                                            <div class="mb-3"><input class="form-control" type="password" name="Telephone" placeholder="Telephone"></div>
                                                            <div class="mb-3"><input class="form-control" type="password" name="Address" placeholder="Address"></div>
