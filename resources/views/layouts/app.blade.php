    ...
    <header class="masthead" style="background-image: url('{{ asset("/img/pc-gamer.webp") }}');">
        <div class="container">
            <div class="intro-text" style="padding-top: 120px;padding-bottom: 25px;">
                ...
                <a class="btn btn-primary btn-xl text-uppercase" role="button" href="#services" style="/*border-bottom-color: var(--bs-info-text-emphasis);*//*background-color: var(--bs-info-text-emphasis);*//*border-color: var(--bs-info-text-emphasis);*//*accent-color: var(--bs-info-text-emphasis);*/">take a look!</a>
            </div>
        </div>
    </header>
